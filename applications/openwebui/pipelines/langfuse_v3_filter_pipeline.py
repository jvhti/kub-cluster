...
class Pipeline:
    ...
    async def inlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        try:
            ...
            event_span._otel_span.set_attribute('user.id', user_email or 'unknown')
            event_span._otel_span.set_attribute('session.id', chat_id)
            event_span.end()
    ...
    async def outlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        try:
            ...
            generation._otel_span.set_attribute('user.id', user.get('email') if user else 'unknown')
            generation._otel_span.set_attribute('session.id', chat_id)
